import 'package:agora_flutter_webrtc_quickstart/pages/accountsecurity/accountsecurity.dart';
import 'package:agora_flutter_webrtc_quickstart/pages/login.dart';
import 'package:agora_flutter_webrtc_quickstart/pages/notifications/notifications.dart';
...
import 'package:agora_flutter_webrtc_quickstart/widgets/globalwidgets.dart';
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    GestureDetector(
                      onTap: () {
                        navigateTo(Notifications(), context);
                      },
                      child: Row(
                        children: <Widget>[
                          Text(
                    ...
                    GestureDetector(
                      onTap: () {
                        navigateTo(AccountSecurity(), context);
                      },
                      child: Row(
                        children: <Widget>[
                          Text(
